...
export const myProjects = [
  ...
  {projectTitle: "Conclusion: Writing the Next Chapter" , nav:"/Page6" ,subTitle : "Though the story so far has been bleak, it’s not over. This is where the audience becomes the hero. With the right actions, we can still rewrite the ending." , imgPath:"./images/6.jpg"},
